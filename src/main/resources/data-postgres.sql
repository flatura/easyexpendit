...
INSERT INTO consumable (name, contract, price, part_number, category_id, status)
VALUES ('Картридж Galaprint HP 35A, HP 36A, HP 85A', '1507/21/148-М', 300, 'CB435A, CB436A, CE285A', 100001, 2),
       ('Картридж Galaprint HP 35A, HP 36A, HP 85A', '1507/21/148-М', 300, 'CB435A, CB436A, CE285A', 100001, 2),
       ('Картридж Galaprint HP 35A, HP 36A, HP 85A', '1507/21/148-М', 300, 'CB435A, CB436A, CE285A', 100001, 2),
       ('Картридж Galaprint HP 78A, Canon 728', '1507/21/148-М', 400, 'CE278A', 100001, 2),
       ('Картридж NV-Print HP 25X', '1507/21/148-М', 700, 'CE255X', 100001, 2),
       ('Картридж NV-Print HP 25X', '1507/21/148-М', 700, 'CE255X', 100001, 2),
       ('Кабель CableExpert HDMI 15 м', '1507/21/148-М', 1500, 'noname', 100004, 2),
       ('Кабель CableExpert HDMI 15 м', '1507/21/148-М', 1500, 'noname', 100004, 2),
       ('Кабель CableExpert HDMI 15 м', '1507/21/148-М', 1500, 'noname', 100004, 2),
       ('Кабель CableExpert HDMI 15 м', '1507/21/148-М', 1500, 'noname', 100004, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Мышь Logitech M100', '1507/21/148-М', 200, 'M100', 100006, 2),
       ('Kingston 480G SSD', '1507/21/148-М', 3500, 'SA400S37/480G', 100009, 2),
       ('Kingston 480G SSD', '1507/21/148-М', 3500, 'SA400S37/480G', 100009, 2),
       ('Kingston 480G SSD', '1507/21/148-М', 3500, 'SA400S37/480G', 100009, 2),
       ('Kingston 480G SSD', '1507/21/148-М', 3500, 'SA400S37/480G', 100009, 2);

INSERT INTO consumable (id, name, contract, price, part_number, category_id, status)
VALUES ('cb0cd54a-b6b2-4d2d-829e-7f0128ac7db6','Картридж Galaprint HP 35A, HP 36A, HP 85A','1507/21/148-М',300,'CB435A, CB436A, CE285A',100001,3),
       ...
       ('46ec581e-79e3-46be-938f-d0219cfa9335', 'Картридж NV-Print HP 25X', '1507/21/148-М', 700, 'CE255X', 100001, 4),
       ('ea1fbbf0-f13e-4cf8-a71d-3d8eceb843a3', 'Картридж NV-Print HP 25X', '1507/21/148-М', 700, 'CE255X', 100001, 4);
...
VALUES (3, 'cb0cd54a-b6b2-4d2d-829e-7f0128ac7db6', '0d9b7adf-7879-4c4d-915f-d7cb0419028a', '1507 / Директор'),
       ...
       (4, '46ec581e-79e3-46be-938f-d0219cfa9335', '63ee60d7-b779-45bd-89a6-f3607ccab181', ''),
       (4, 'ea1fbbf0-f13e-4cf8-a71d-3d8eceb843a3', '63ee60d7-b779-45bd-89a6-f3607ccab181', '');